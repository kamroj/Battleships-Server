...
public class ActiveBoardsTest {
    ...
    public void setUp() {
        ...
        Board playerOneBoard = new Board(Arrays.asList(
                new Ship(Arrays.asList(1, 2, 3)),
                new Ship(Arrays.asList(10, 20, 30, 40))));

        Board playerTwoBoard = new Board(Arrays.asList(
                new Ship(Arrays.asList(1, 2, 3)),
                new Ship(Arrays.asList(10, 20, 30, 40))));
